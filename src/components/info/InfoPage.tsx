    ...
    const handleStartMigration = async () => {
        ...
        try {
            ...
            try {
                ...
                dispatch({
                    type: "SET_PERMIT_SIGNATURE",
                    payload: permitSignature,
                });
            } catch (permitError) {
                console.warn(
                    "Failed to sign permit, will set viewing keys manually:",
                    permitError,
                );
            }
    ...
    return (
        ...
        >
            ...
            <div style={{ textAlign: "center", marginBottom: "2rem" }}>
                ...
                >
                    Withdraw your funds from Secret Swap reward and liquidity
                    pools.
                </p>
            </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    Connect your Keplr wallet and sign a permit
                                    message use as a viewing key.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    Set viewing keys for pools that need them,
                                    then withdraw your staked tokens and earned
                                    rewards.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    Withdraw your underlying assets from AMM
                                    liquidity pools.
                                </p>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                style={{ color: "var(--color-text-secondary)" }}
                            >
                                Have at least <strong>1 SCRT</strong> in your
                                wallet for transaction fees
                            </span>
                        </div>
                        <div
                            style={{
                        ...
                        >
                            ...
                            <span
                                style={{ color: "var(--color-text-secondary)" }}
                            >
                                The permit signature will be saved locally for
                                future visits
                            </span>
                        </div>
                    </div>
